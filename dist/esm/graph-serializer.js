 ...
 * @returns {any}
 */
export function deserialize(type, src) {
    if (src === null) {
        return null;
    }
 ...
 * @type {Scheme}
 */
export var primitive = new Scheme();
/**
 * Date scheme type.
 ...
 * @returns {Scheme}
 */
export function array(childScheme) {
    if (childScheme === void 0) { childScheme = primitive; }
    var scheme = new Scheme();
    scheme.serializer = function (v) {
        return v.map(function (w) { return resolveScheme(childScheme).serializer(w); });
    };
    scheme.deserializer = function (v) {
        if (v === undefined)
            return v;
        return v.map(function (w) { return resolveScheme(childScheme).deserializer(w); });
    };
    return scheme;
}
/**
 ...
 * @returns {Scheme}
 */
export function objectMap(childScheme) {
    if (childScheme === void 0) { childScheme = primitive; }
    var scheme = new Scheme();
    scheme.serializer = function (v) {
 ...
 * @returns {Scheme}
 */
export function custom(serializer, deserializer) {
    var scheme = new Scheme();
 ...
 * @returns {any}
 */
export function serializable(settings) {
    if (settings === void 0) { settings = {}; }
 ...
 * @returns {any}
 */
export function deserializationFactory() {
    return function (type, propertyName, propertyDescriptor) {
        if (arguments.length !== 3) {
            throw new Error("Invalid decorator");
        }
