...
export declare type SchemeFn = (() => Scheme);
/**
 ...
 * @returns {Scheme}
 */
export declare function array(childScheme?: Scheme | SchemeFn): Scheme;
/**
 * Array scheme type
 * The array function will apply a scheme to all of its children.
 *
 ...
 * @returns {Scheme}
 */
export declare function objectMap(childScheme?: Scheme | SchemeFn): Scheme;
/**
 * Object scheme type
